      ...
      <Box as='section' h='90vh' bgImage={bg} bgRepeat='no-repeat' bgPos='center' mb='2rem' >
         <Container maxW='1100px' h='100%'>
            <Flex justify='center' align='center' h='100%' gap='1rem'>
               ...
               <Box backdropFilter='auto' backdropBlur='8px' padding='1rem' borderRadius='10px' h='60%'>
                  <Text mb='1rem' textAlign='center' fontSize='2rem' color='white' textShadow='2px 2px black'>
